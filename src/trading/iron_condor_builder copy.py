...
class IronCondor:
    ...
    def from_dict(cls, payload: Dict[str, Any]) -> "IronCondor":
        ...
        return cls(
            ...
            short_put=_to_float(sp, 0.0),
            long_put=_to_float(lp, 0.0),
            short_call=_to_float(sc, 0.0),
            long_call=_to_float(lc, 0.0),
            short_put_price=_to_float(spp, 0.0),
            long_put_price=_to_float(lpp, 0.0),
            short_call_price=_to_float(scp, 0.0),
